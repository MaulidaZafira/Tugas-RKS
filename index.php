...
<body class="hold-transition skin-blue sidebar-mini">
  ...
  <div class="wrapper">
    <div class="logo">
      ...
      <span class="jd-logo">Sistem Portal Akademik</span>
      <span class="nm-sek">Universitas Ahmad Dahlan</span>
    </div>
    <header class="main-header">
      <!-- Logo -->
      <div href="#" class="logo">
        <!-- mini logo for sidebar mini 50x50 pixels -->
        <span class="logo-mini"><b>Ssw</b></span>
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown user user-menu">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                ...
                <span class="hidden-xs">dsjahdjsahkjd</span>
              </a>
              <ul class="dropdown-menu">
                ...
                <li class="user-footer">
                  ...
                  <div class="pull-right">
                    <a href="#" class="btn btn-default btn-flat"><i class="fa fa-sign-out"> Keluar</i></a>
                  </div>
                </li>
              </ul>
            </li>
    ...
    <footer class="main-footer">
      ...
      &copy; Copyright <?php echo date('Y');  ?> Maulida Zafira
    </footer>
